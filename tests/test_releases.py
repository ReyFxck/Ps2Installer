...
class ReleaseResolverTests(unittest.TestCase):
    def test_stable_and_prerelease_are_separate(self):
        payload = [
            {
                "tag_name": "latest",
                "name": "latest",
        ...
        self.assertEqual([o.channel for o in options], ["stable", "prerelease"])
    ...
    def test_latest_development_uses_date_fallback(self):
        payload = [
            {
                "tag_name": "latest",
